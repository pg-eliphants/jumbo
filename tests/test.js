    ...
    promise = promise
        ...
        .then(async (x) => {
            ...
            if (expected !== got) {
                failed = true;
                throw new Error(
                    util.inspect(expected) + " != " + util.inspect(got),
                );
            }
        ...
        .catch((err) => {
            ...
            tests[line].error =
                err instanceof Error ? err : new Error(util.inspect(err));
        })
        .then(() => {
    ...
    Object.values(tests).every((x) => {
        ...
        x.cleanup
            ...
            : console.error(
                  ...
                  x.name + " at line",
                  x.line,
                  x.failed ? "failed" : "never finished",
