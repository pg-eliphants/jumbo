...
export const arraySerializer = function arraySerializer(
    xs,
    serializer,
    options,
    typarray,
...
function arrayParserLoop(s, x, parser, typarray) {
    ...
    s.last < s.i &&
        xs.push(
            parser
                ? parser(x.slice(s.last, s.i + 1))
                : x.slice(s.last, s.i + 1),
        );
    return xs;
}
