...
declare namespace postgres {
    ...
    interface ArrayParameter<T extends readonly any[] = readonly any[]>
    ...
    type ExecutionResult<T> = [] &
        ResultQueryMeta<number, keyof NonNullable<T>>;
    ...
    interface PendingQueryModifiers<TRow extends readonly any[]> {
        ...
        ): AsyncIterable<NonNullable<TRow[number]>[]>;
        cursor(
    ...
    interface Sql<TTypes extends Record<string, unknown> = {}> {
         ...
         */
        <T, K extends Rest<T>>(
            first: T & First<T, K, TTypes[keyof TTypes]>,
            ...rest: K
        ): Return<T, K>;
        ...
        typed: (<T>(value: T, oid: number) => Parameter<T>) & {
            [name in keyof TTypes]: (
                value: TTypes[name],
            ) => postgres.Parameter<TTypes[name]>;
        };
        ...
        array<
            T extends SerializableParameter<
                TTypes[keyof TTypes]
            >[] = SerializableParameter<TTypes[keyof TTypes]>[],
        >(
            value: T,
